...
export class AddVideoComponent implements OnInit {
  ...
  addVideo():void{
    ...
    console.log('add video submitted');
    this.admin.addVideo(this.video).subscribe(
    (data: any) => {
          //console.log(data);
          //show success msg to admin user
          this.msg = " Video Added Successfully ";
    ...
    validateVideoSerialNo(serial_no:any){
      if(serial_no=='null'){
  ...
  validateTitle(title:any,topic_id:any,subject_id:any,course_id:any){
      ...
      //check if video title of topic of subject of course exists already in server db
      this.admin.checkIfVideoOfTopicOfSubjectOfCourseExists(title,topic_id,subject_id,course_id).subscribe(
        (res: any) => {
           //console.log(res);
           if(res['result']==0){
  ...
  this.admin.getSingleSubjectTopics(subject_id).subscribe(
   ...
   getSerials(course_id:any,subject_id:any,topic_id:any){
            ...
            this.admin.getCourseSubjectTopicVideosSerials(course_id,subject_id,topic_id).subscribe(
              (res: any) => {
                 //console.log(res);
